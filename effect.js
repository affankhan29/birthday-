	...
	$('#story').click(function(){
		...
		function msgLoop (i) {
			...
			if(i==50){
				...
				const videobutton = document.getElementById("story1");
...
music.pause();
  ...
  video.style.display = "block";
	document.getElementById("cake1").style.display = "none";
  ...
  if (video.requestFullscreen) {
    video.requestFullscreen().then(() => {
      ...
      console.error("Error trying to play video in fullscreen:", err);
    });
    ...
    // If fullscreen is not supported, just play the video normally
    video.play();
  }
